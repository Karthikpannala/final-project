...
# Load Data
movie_data <- read.csv("C:/Users/User/Desktop/ml final proect/movies.csv", stringsAsFactors = FALSE)
rating_data <- read.csv("C:/Users/User/Desktop/ml final proect/ratings.csv")
